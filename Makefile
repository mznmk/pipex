...
#    Updated: 2022/04/01 11:09:35 by mmizuno          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(P0_C1_NAME):		$(P0_C1_OBJS)
					@make $(LIBFT_NAME)
					$(CC) $(CFLAGS) $(P0_C1_OBJS) $(LIBDIR) $(LIBS) -o $(P0_C1_NAME)
					@echo "$(FNT_BOLD)$(CLR_GREEN)[ $(NAME) successfully compiled !! ]$(ESC_RESET)"
...
$(P1_C2_NAME):		$(P1_C2_OBJS)
					@make $(LIBFT_NAME)
					$(CC) $(CFLAGS) $(P1_C2_OBJS) $(LIBDIR) $(LIBS) -o $(P1_C2_NAME)
					@echo "$(FNT_BOLD)$(CLR_GREEN)[ $(NAME) successfully compiled !! ]$(ESC_RESET)"
...
$(P2_C3_NAME):		$(P2_C3_OBJS)
					@make $(LIBFT_NAME)
					$(CC) $(CFLAGS) $(P2_C3_OBJS) $(LIBDIR) $(LIBS) -o $(P2_C3_NAME)
					@echo "$(FNT_BOLD)$(CLR_GREEN)[ $(NAME) successfully compiled !! ]$(ESC_RESET)"
...
clean:
					...
					$(RM) $(MANDA_OBJS) $(P0_C1_OBJS) $(P1_C2_OBJS) $(P2_C3_OBJS)

# ---------------------------------- fclean ---------------------------------- #

fclean:				clean
					@cd $(LIBFT_DIR) && make fclean
					$(RM) $(MANDA_NAME) $(P0_C1_NAME) $(P1_C2_NAME) $(P2_C3_NAME)
